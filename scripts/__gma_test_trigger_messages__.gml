{
  ...
  test_case_no_trigger(assert_operation(584, 583, __gma_greater_than__, false));
  test_case_trigger(assert_operation(582, 583, __gma_greater_than__, false));
  test_case_trigger(assert_operation(584, 583, __gma_greater_than__, true));
  test_case_no_trigger(assert_operation(582, 583, __gma_greater_than__, true));
