...
///__gma_assert_error__(message, expected, got)
{
  ...
  if (GMASSERT_ENABLED && ((gtbp != -1 && !script_execute(gtbp, argument0, argument2, argument1)) || (gbp != -1 && gbp == -1 && !script_execute(gbp, argument0, argument2, argument1)))) {
...
///__gma_assert_error_simple__(message, got)
{
  var gtbp = asset_get_index("__GMA_TEST_BREAKPOINT__"),
      gbp = asset_get_index("__GMA_BREAKPOINT__");
  if (GMASSERT_ENABLED && ((gtbp != -1 && !script_execute(gtbp, argument0, argument1, "")) || (gbp != -1 && gtbp == -1 && !script_execute(gbp, argument0, argument1, "")))) {
